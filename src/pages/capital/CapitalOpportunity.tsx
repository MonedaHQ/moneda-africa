...
const metrics = [
  {
    value: '$150m+',
    desc: 'Supported across African local content supply chains since inception',
  },
  {
    value: '<5%',
  ...
  {
    value: '75 days',
    desc: 'Average credit-support cycle — fast, rotating, productive execution',
  },
  {
    value: '30+',
      ...
      <div className={styles.inner}>
        ...
        >
          ...
          <p className={styles.body}>
            ...
            to deliver. The banks often will not fund them. Moneda supports the
            execution and credit structures that help delivery happen.
          </p>
        </motion.div>
      </div>
