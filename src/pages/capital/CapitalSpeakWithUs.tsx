      ...
      <div className={styles.inner}>
        ...
        <div className={styles.left}>
          ...
          <motion.p className={styles.body} {...fadeUp(0.16)}>
            ...
            call centres — a direct conversation with the Moneda fund
            management team.
          </motion.p>
        ...
        <motion.div className={styles.right} {...fadeUp(0.12)}>
          <div className={styles.card}>
            ...
            <blockquote className={styles.quote}>
              ...
              We are not raising funds through intermediaries. Every investor
              conversation is handled directly by the Moneda fund management
              team.
            ...
            <CapitalButton variant="solid" href="mailto:info@moneda.africa">
              Contact the Team
              <TbArrowRight />
            </CapitalButton>
          </div>
