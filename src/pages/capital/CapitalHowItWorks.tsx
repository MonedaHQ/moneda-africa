...
const steps = [
  ...
  {
    number: '03',
    title: 'Credit support directed. Moneda co-executes.',
    body: "Credit support is directed toward goods or assets required to execute the contract. Moneda's operations team co-executes on the ground — supervising every disbursement, milestone, and delivery.",
  },
  {
    number: '04',
    title: 'Returns distributed',
    body: 'Contract delivered. Proceeds flow back through the receivable structure. Semi-annual distributions. Full capital repayment at 12-month maturity. Less than 5% NPL across 100+ transactions.',
  },
];
...
const fundTerms = [
  ...
  { label: 'Principal repayment', value: 'Bullet at maturity', badge: null },
