...
function CapitalManagement() {
  ...
  const imageAndTextContent = {
    ...
    paragraph:
      'We deploy capital with purpose—backing the enterprises and sectors driving Africa’s next chapter of growth. <br/><br/>Moneda’s capital management vertical channels institutional and private credit in Africa into high-impact sectors: agriculture, energy, mining, and infrastructure. Through Moneda Capital, our Mauritius-licensed fund and asset management arm, we finance critical SMEs with a focus on sustainable returns and transformative outcomes. <br/><br/>With operational presence in South Africa and a digital capital access platform—Musa—we bridge frontier opportunity with global investment discipline, advancing African credit and reinforcing local content in Africa. <br/><br/><strong>What We Offer:</strong><ul><li>Growth capital for high-impact sectors</li><li>Structuring and fund management expertise</li><li>Ethical investing with rigorous due diligence</li><li>Digital capital access via Musa</li></ul>',
    contentFirst: true,
  };
  return (
    <>
