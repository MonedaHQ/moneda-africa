        ...
        <div className={styles.content}>
          <div className={styles.heading}>
            ...
            <p>
              ...
              We work with partners and stakeholders who share this mission.
              Together, we can build a future where Africa’s resources are fully
              harnessed, its communities are empowered, and its enterprises
              drive sustainable, inclusive prosperity.
            </p>
          </div>
