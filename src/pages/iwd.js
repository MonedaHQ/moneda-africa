...
function IWDHome() {
  const heroContent = {
    ...
    content: {
      ...
      paragraph:
        'Women are the backbone of thriving communities, leading in ways big and small—from markets to estates, churches to workplaces. Now, it’s time to spotlight their impact. <br/> <br/>Moneda’s #LeadingHerCommunity Challenge is a call to action for women who have stepped up as community leaders. Whether you’re organizing, advocating, or driving change, your story can inspire others to do the same. Join the challenge, share your journey, and stand a chance to win NGN500,000!',
    },
  };
  return (
    <>
